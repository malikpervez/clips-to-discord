...
{
    private static readonly StableVersion InstalledVersion = new(1, 8, 0);
    ...
    {
        Assert(StableVersion.TryParse("v1.8.0", out var parsedVersion) && parsedVersion == InstalledVersion,
        ...
        Assert(StableVersion.FromAssemblyVersion(new Version(1, 8, 0, 0)) == InstalledVersion,
        ...
        await AssertStatusAsync(BuildReleaseJson(tag: "v1.8.0"), UpdateCheckStatus.UpToDate,
