...
{
    private static readonly StableVersion InstalledVersion = new(1, 11, 2);
    ...
    {
        Assert(StableVersion.TryParse("v1.11.2", out var parsedVersion) && parsedVersion == InstalledVersion,
        ...
        Assert(StableVersion.FromAssemblyVersion(new Version(1, 11, 2, 0)) == InstalledVersion,
        ...
        await AssertStatusAsync(BuildReleaseJson(tag: "v1.11.2"), UpdateCheckStatus.UpToDate,
