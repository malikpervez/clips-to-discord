...
{
    private static readonly StableVersion InstalledVersion = new(1, 6, 1);
    ...
    {
        Assert(StableVersion.TryParse("v1.6.1", out var parsedVersion) && parsedVersion == InstalledVersion,
        ...
        Assert(StableVersion.FromAssemblyVersion(new Version(1, 6, 1, 0)) == InstalledVersion,
        ...
        await AssertStatusAsync(BuildReleaseJson(tag: "v1.6.1"), UpdateCheckStatus.UpToDate,
