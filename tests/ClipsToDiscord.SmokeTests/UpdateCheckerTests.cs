...
{
    private static readonly StableVersion InstalledVersion = new(1, 6, 0);
    ...
    {
        Assert(StableVersion.TryParse("v1.6.0", out var parsedVersion) && parsedVersion == InstalledVersion,
        ...
        Assert(StableVersion.FromAssemblyVersion(new Version(1, 6, 0, 0)) == InstalledVersion,
        ...
        await AssertStatusAsync(BuildReleaseJson(tag: "v1.6.0"), UpdateCheckStatus.UpToDate,
